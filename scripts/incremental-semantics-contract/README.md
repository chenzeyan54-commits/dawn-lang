...
twenty one context-owned query dispatches, four acceptance/refusal controls and
three checker-dispatcher controls.
Canonical query capture remains unchanged in each private subject; every mutant
must compile and reach its named assertion owner. Two positives and 28 controls
